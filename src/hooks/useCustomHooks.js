...
export const useCustomHook = () => {
  ...
  const [searchParams] = useSearchParams(); // XXX/page=1&size=10
  ...
  const moveToList = (pageParam) => { // { page: 1, size: 10, keyfield: XXX, keyword: XXX }
  ...
  const moveToView = (id) => {
    navigate({ pathname: `../view/${id}`, search: queryDefault }); // list?page=1&size=10
  }
